...
let musicSubcriptionPlan_1 = 17.00
let bankAcount = 230.00

function withdrawMusicSub(){
    // if money exists - withdraw money for sub
    console.log(bankAccount-musicSubcriptionPlan_1)
    // if no money - pause sub
}

// Assignment Operators - applying a value to a variable
// MAIN TAKEAWAY : the single equal symbol is used for assignments
...
// Comparison Operators - analysing values to one another
...
console.log(depositAmount === savingsAccount)
