...
"1."
// var is a universal container for data, making it well versed. 
// let varifies that information can or is allowed to change.
// const declares that data CANNOT or SHOULD NOT change. It
// is a constant.
...
console.log(a*b*c)  
 ...
 "3."
 "You would use the let variable to show time, because time will change every second or minute."
 "Const would be used to show the current city you want to tell the weather in."

 "4."
 // I do not feel that the class should change. 
 // The class is like a college course.
 // If students do not lock in, they are more prone to fail.